...
<form method="post">
	<table class="jc_table" width="100%"
		...
		<tr>
			<th>내용</th>
			<td><textarea name="bContent" rows="10" class="form-control" required="required">${updateBoard.bContent}</textarea></td>
		</tr>
	</table>
	<br> <input type="submit" value="수정" class="btn btn-dark" >
</form>

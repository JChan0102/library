...
<form>
	<div class="alert alert-light">
		<table class="jc_table" style="border-bottom: 2px solid #547980; border-top: 2px solid #547980; width: 100%;">
			<tr>
				<th style="width: 10%;">아이디</th>
				<td style="width: 25%;">${memberLoginInfo.member_id}</td>
				<th style="width: 5%;" rowspan="3">요약</th>
				<td style="width: 60%;" rowspan="3">${memberLoginInfo.name}님은<br> 현재까지 <b>${memberLoginInfo.totborrowDays}일</b>
					동안 책을 빌리셨습니다.<br>현재까지의 총 연체일은 <b>${memberLoginInfo.totoverduedays}일</b>입니다!<br>
					<c:choose>
		...
		<br>
		<a
			href="${pageContext.request.contextPath}/member/memberAccount/editMember?member=${memberLoginInfo.member_id}"><button class="adminHomeBigBtn color3_btn custom_btn" type="submit"><i class="fas fa-book-reader fa-fw"></i>  도서 대출/반납</button></a>
		<a
